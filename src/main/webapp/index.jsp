...
<div class="navigation">
  <div class="nav-cent">
    ...
    <div class="city"> <span id="DY_site_name" class="red city-name Left">南京</span>
          ...
          <div class="hideMap">
            <div class="showPanel clearfix">
              <div class="Left mycity">
                <div id="JS_current_city_box"> 当前城市：<strong id="JS_city_current_city">南京</strong> </div>
    ...
    <div class="r-news">
      ...
      <div class="r-news-list">
        <ul>
          ...
          <li><span class="date">09月28日</span><i class="icon "></i><a href="newsinfor.html" title="关于2018年国庆节放假工作安排的通知"> 关于2018年国庆节放假工作安... </a> </li>
...
<div id="popBox">
  <div class="popCont"> <a class="p_closed">关闭</a>
    ...
    <div class="p-detail">
      <div class="p-dl">
        <form onsubmit="return check();" enctype="multipart/form-data" method="get" name="form" id="form" action="${pageContext.request.contextPath}/user/checkLogin">
          <ul class="login-items">
            <li>
              <label>用户名(手机号)</label>
              <input class="input" type="text" value="" maxlength="32"  name="phone" placeholder="请输入您的手机号">
            </li>
            <li>
              <label>密码</label>
